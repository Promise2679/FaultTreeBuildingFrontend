...
export const mockFaultTreeData: FaultTreeResponse = {
  ...
  nodes: [
    ...
    { hasChildren: 1, nodeId: 'node_2', nodeName: '电源故障', nodeType: 'INTERMEDIATE', parentId: 'node_1' },
    { hasChildren: 1, nodeId: 'node_3', nodeName: '控制单元故障', nodeType: 'INTERMEDIATE', parentId: 'node_1' },
